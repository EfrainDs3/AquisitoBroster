...
public class CajaSesionResponse {
    ...
    public CajaSesionResponse(Long id, String usuario, LocalDateTime fechaApertura, LocalDateTime fechaCierre, BigDecimal montoApertura, BigDecimal ingresosVentas, BigDecimal egresosAdicionales, BigDecimal montoCierre, String estado) {
        this.id = id;
